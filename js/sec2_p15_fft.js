...
//======================================================================
// 3. 2D Fourier Transform Visualizer
//    uses FFTUtils for core logic.
//======================================================================
...
class FourierVisualizer2D {
    ...
    init() {
        ...
        styleElement.textContent = `
            ...
            .control-section h3 { color: #e8eaed; margin-bottom: 12px; font-size: 1rem; }
            .visualization-area { padding-left: 20px; }
            .image-panel, .spectrum-panel { background: rgba(255, 255, 255, 0.03); padding: 10px; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); }
            .image-panel h4, .spectrum-panel h4 { color: #e8eaed; margin-bottom: 8px; font-size: 0.9rem; }
            .image-panel canvas, .spectrum-panel canvas { width: 100%; height: auto; max-width: 256px; border: 1px solid rgba(255, 255, 255, 0.15); background: #0f1419; }
            .btn { background: rgba(255, 255, 255, 0.08); border: 1px solid rgba(255, 255, 255, 0.15); color: #e8eaed; padding: 8px 16px; border-radius: 4px; cursor: pointer; transition: all 0.3s; }
            .btn:hover { background: rgba(100, 180, 255, 0.15); border-color: rgba(100, 180, 255, 0.3); }
            .btn-primary { background: linear-gradient(135deg, #1565c0, #42a5f5); border: none; }
            .btn-primary:hover { background: linear-gradient(135deg, #1976d2, #64b5f6); }
