...
const renderAlgebraCompass = () => {
    ...
    const structures = [
        ...
        { name: "UFD",              r: 145, color: "#8e44ad", desc: "Unique Factorization Domain. Guaranteed unique 'prime' decomposition.", ex: "ℤ[x] (A UFD, but not a PID)" },
        { name: "PID",              r: 105, color: "#5f27cd", desc: "Principal Ideal Domain. Every ideal is generated by a single element.", ex: "ℤ, ℚ[x]" },
