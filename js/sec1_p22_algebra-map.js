...
const renderAlgebraCompass = () => {
    ...
    const structures = [
        ...
        { 
            ...
            r: 190, 
            color: "#2980b9", 
            desc: "A commutative ring with no zero divisors. Ensures ab=0 implies a=0 or b=0.", 
            ex: "Quadratic Integer Ring ℤ[√-5] (Not a UFD!)" 
        },
        { 
            name: "Unique Factorization Domain", 
            r: 145, 
            color: "#8e44ad", 
            desc: "Every non-zero non-unit can be written uniquely as a product of irreducibles.", 
            ex: "Polynomial Rings over a UFD (e.g., ℤ[x])" 
        },
        { 
            name: "Principal Ideal Domain", 
            r: 105, 
            color: "#5f27cd", 
            desc: "An integral domain where every ideal is generated by a single element.", 
            ex: "The Ring of Integers ℤ, Polynomial Rings over a Field F[x]" 
        },
        { 
            name: "Euclidean Domain", 
            r: 70,  
            color: "#341f97", 
            desc: "A domain where division with remainder exists, enabling the Euclidean Algorithm.", 
            ex: "The Ring of Integers ℤ, The Ring of Gaussian Integers ℤ[i]" 
        },
        { 
            name: "Field", 
            r: 35,  
            color: "#00d2d3", 
            desc: "The strongest structure. Every non-zero element has a multiplicative inverse.", 
            ex: "Rational Numbers ℚ, Real Numbers ℝ, Finite Fields (Galois Fields)" 
        }
    ];
