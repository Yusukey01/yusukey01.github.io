...
(function () {
    ...
    function initSvmDemo() {
        ...
        style.textContent = [
            ...
            '#svm_visualizer select{width:100%;background:#1a2534;color:' + C.text + ';border:1px solid ' + C.panelBorder + ';border-radius:5px;padding:6px 8px;font-size:0.88rem;color-scheme:dark;}',
            '#svm_visualizer select option{background:#1a2534;color:' + C.text + ';}',
